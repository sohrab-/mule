...
public interface ExtensionsManager
{
     ...
     * <li>Those classes are loaded and registered as {@link org.mule.extensions.introspection.api.Extension}s</li>
     * </ul>
     * <p/>
     * If an {@link org.mule.extensions.introspection.api.Extension} is found which is already registered,
     ...
     * <p/>
     * Finally, a {@link java.util.List} will be returned with the {@link org.mule.extensions.introspection.api.Extension}s
     ...
     * @return a {@link java.util.List} with the registered or updated {@link org.mule.extensions.introspection.api.Extension}s or
