...
public class HttpOutboundFlowPerformanceTestCase extends AbstractMuleTestCase
{
    @Rule
    ...
    public HttpOutboundFlowPerformanceTestCase(boolean staleCheckEnabled, boolean singletonDispatcher)
    {
    ...
    public void before() throws Exception
    {
        ...
        flow.setMessageProcessors(Collections.<MessageProcessor> singletonList(endpoint));
    ...
    {
        flow.process(createMuleEvent()).getMessageAsBytes();
    }
