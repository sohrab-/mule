...
public final class SchemaConstants
{
    ...
    public static final QName INTEGER = new QName(MULE_NAMESPACE, "substitutableInt", "mule");
    ...
    public static final QName LONG = new QName(MULE_NAMESPACE, "substitutableLong", "mule");
    public static final QName BYTE = new QName(XSD_NAMESPACE, "byte", "xs");
    public static final QName BOOLEAN = new QName(MULE_NAMESPACE, "substitutableBoolean", "mule");
